...
find src/game/ src/ui/ src/cgame/ -name '*.c' -o -name '*.cpp' | sort | xgettext \
\--from-code=UTF-8 --package-name="ET: Legacy" --copyright-holder="Jan Simek" --package-version="2.70rc2" --msgid-bugs-address="bugs@etlegacy.com" -o etlegacy_mod.pot -k_ -k__ -kCG_TranslateString -ktrap_TranslateString -f -
