...
RUN mkdir -p /opt/cmake && wget --no-check-certificate --quiet -O - https://cmake.org/files/v3.19/cmake-3.19.2-Linux-x86_64.tar.gz | tar --strip-components=1 -xz -C /opt/cmake
