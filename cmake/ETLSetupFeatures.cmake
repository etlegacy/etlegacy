...
if(BUILD_CLIENT)
	...
	if(NOT FEATURE_RENDERER_GLES)
		if(NOT BUNDLED_GLEW)
			...
			target_link_libraries(renderer_libraries INTERFACE ${BUNDLED_GLEW_LIBRARIES})
			target_include_directories(renderer_libraries INTERFACE ${BUNDLED_GLEW_INCLUDE_DIR})
			target_compile_definitions(renderer_libraries INTERFACE BUNDLED_GLEW GLEW_STATIC)
		endif()
	...
	if(NOT BUNDLED_JPEG)
		...
		target_link_libraries(renderer_libraries INTERFACE ${JPEG_BUNDLED_LIBRARIES})
		target_include_directories(renderer_libraries INTERFACE ${JPEG_BUNDLED_INCLUDE_DIR})
	endif()
	...
	if(FEATURE_FREETYPE)
		if(NOT BUNDLED_FREETYPE)
			...
			target_link_libraries(renderer_libraries INTERFACE ${BUNDLED_FREETYPE_LIBRARIES})
			target_include_directories(renderer_libraries INTERFACE ${BUNDLED_FREETYPE_INCLUDE_DIR})
		endif()
	...
	if(FEATURE_PNG)
		if(NOT BUNDLED_PNG)
			...
			target_link_libraries(renderer_libraries INTERFACE ${BUNDLED_LIBPNG_LIBRARIES})
			target_include_directories(renderer_libraries INTERFACE ${BUNDLED_LIBPNG_INCLUDE_DIR})
		endif()
	...
	if(FEATURE_OPENAL)
		if(NOT BUNDLED_OPENAL)
			...
			target_link_libraries(client_libraries INTERFACE ${OPENAL_BUNDLED_LIBRARIES})
			target_include_directories(client_libraries INTERFACE ${OPENAL_BUNDLED_INCLUDE_DIR})
			target_compile_definitions(client_libraries INTERFACE AL_LIBTYPE_STATIC)
		endif()
...
if(BUILD_CLIENT OR BUILD_SERVER)
	if(FEATURE_CURL)
		if(NOT BUNDLED_CURL)
			...
			target_link_libraries(engine_libraries INTERFACE ${CURL_BUNDLED_LIBRARY})
			target_include_directories(engine_libraries INTERFACE ${CURL_BUNDLED_INCLUDE_DIR})
			target_compile_definitions(engine_libraries INTERFACE CURL_STATICLIB)
		endif()
	...
	if(FEATURE_SSL)
		...
		elseif(BUNDLED_OPENSSL)
			target_link_libraries(engine_libraries INTERFACE ${OPENSSL_BUNDLED_LIBRARY})
			target_include_directories(engine_libraries INTERFACE ${OPENSSL_BUNDLED_INCLUDE_DIR})
			target_compile_definitions(engine_libraries INTERFACE USING_OPENSSL)
		else() #BUNDLED_WOLFSSL
			target_link_libraries(engine_libraries INTERFACE ${WOLFSSL_BUNDLED_LIBRARY})
			target_include_directories(engine_libraries INTERFACE ${WOLFSSL_BUNDLED_INCLUDE_DIR})
	...
	if(FEATURE_DBMS)
		if(NOT BUNDLED_SQLITE3)
			...
			target_link_libraries(engine_libraries INTERFACE ${SQLITE3_BUNDLED_LIBRARIES})
			target_include_directories(engine_libraries INTERFACE ${SQLITE3_BUNDLED_INCLUDE_DIR})
		endif()
...
if(BUILD_MOD)
	...
	if(FEATURE_LUA)
		if(NOT BUNDLED_LUA)
			...
			target_link_libraries(qagame_libraries INTERFACE ${LUA_BUNDLED_LIBRARIES})
			target_include_directories(qagame_libraries INTERFACE ${LUA_BUNDLED_INCLUDE_DIR})
			target_compile_definitions(qagame_libraries INTERFACE BUNDLED_LUA)
		endif()
...
if(NOT BUNDLED_ZLIB)
	...
	target_link_libraries(engine_libraries INTERFACE ${ZLIB_BUNDLED_LIBRARIES})
	target_include_directories(engine_libraries INTERFACE ${ZLIB_BUNDLED_INCLUDE_DIR})
endif()
...
if(NOT BUNDLED_MINIZIP)
	...
	target_link_libraries(engine_libraries INTERFACE ${MINIZIP_BUNDLED_LIBRARIES})
	target_include_directories(engine_libraries INTERFACE ${MINIZIP_BUNDLED_INCLUDE_DIR})
