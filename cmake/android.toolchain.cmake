...
#   - modified June 2016
#     [+] added support for NDK up to r11b
...
set( ANDROID_SUPPORTED_NDK_VERSIONS ${ANDROID_EXTRA_NDK_VERSIONS} -r11b -r11 -r10e -r10d -r10c -r10b -r10 -r9d -r9c -r9b -r9 -r8e -r8d -r8c -r8b -r8 -r7c -r7b -r7 -r6b -r6 -r5c -r5b -r5 "" )
...
elseif( ANDROID_ABI STREQUAL "arm64-v8a with VFPV4" )
 set( ARM64_V8A true )
 set( ANDROID_NDK_ABI_NAME "arm64-v8a" )
 set( ANDROID_ARCH_NAME "arm" )
 set( ANDROID_ARCH_FULLNAME "arm" )
 set( CMAKE_SYSTEM_PROCESSOR "arm64-v8a" )
 set( VFPV4 true )
elseif( ANDROID_ABI STREQUAL "arm64-v8a with NEON" )
 set( ARM64_V8A true )
 set( ANDROID_NDK_ABI_NAME "arm64-v8a" )
 set( ANDROID_ARCH_NAME "arm" )
 set( ANDROID_ARCH_FULLNAME "arm" )
...
# ABI-specific flags
if( ARMEABI_V8A )
 set( ANDROID_CXX_FLAGS "${ANDROID_CXX_FLAGS} -march=arm64-v8a -mfloat-abi=softfp" )
 if( NEON )
  set( ANDROID_CXX_FLAGS "${ANDROID_CXX_FLAGS} -mfpu=neon" )
 elseif( VFPV4 )
  set( ANDROID_CXX_FLAGS "${ANDROID_CXX_FLAGS} -mfpu=vfpv4" )
 else()
  set( ANDROID_CXX_FLAGS "${ANDROID_CXX_FLAGS} -mfpu=vfp3" )
 endif()
if( ARMEABI_V7A )
...
macro( ANDROID_GET_ABI_RAWNAME TOOLCHAIN_FLAG VAR )
 ...
 elseif( "${TOOLCHAIN_FLAG}" STREQUAL "ARMEABI_V7A" )
    set( ${VAR} "armeabi-v7a" )
 elseif( "${TOOLCHAIN_FLAG}" STREQUAL "ARMEABI_V8A" )
    set( ${VAR} "arm64-v8a" )
