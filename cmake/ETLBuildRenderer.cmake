...
if(FEATURE_RENDERER2)
	...
	set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -O2 -Ob2 -Oi -Ot -Oy -GT -GL -Zp16 -Gy -arch:SSE2")
	set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O2 -Ob2 -Oi -Ot -Oy -GT -GL -Zp16 -Gy -arch:SSE2")
	set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -m32 -INCREMENTAL:NO -LTCG")
	set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -m32 -INCREMENTAL:NO -LTCG")
	set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} -m32 -INCREMENTAL:NO -LTCG")
