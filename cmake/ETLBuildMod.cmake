...
if(BUILD_MOD_PK3)
	# etmain
	file(GLOB_RECURSE	CONFIGURE_DEPENDS ETMAIN_FILES			"${CMAKE_CURRENT_SOURCE_DIR}/etmain/*")
	file(GLOB			CONFIGURE_DEPENDS ETMAIN_FILES_SHALLOW	"${CMAKE_CURRENT_SOURCE_DIR}/etmain/*")
