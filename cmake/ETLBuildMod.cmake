...
if(BUILD_MOD_PK3)
	...
	foreach(FILE ${ETMAIN_FILES_IN})
		...
		file(COPY ${FILE} DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/${MODNAME}")
	endforeach()
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND} -E tar c ${CMAKE_CURRENT_BINARY_DIR}/${MODNAME}/${MODNAME}_${ETL_CMAKE_VERSION_SHORT}.pk3 --format=zip ${ZIP_FILE_LIST}
