...
// full window
#define FULL_WINDOW_X        0
#define FULL_WINDOW_Y        0
#define FULL_WINDOW_WIDTH    __WINDOW_WIDTH
#define FULL_WINDOW_HEIGHT   480
...
// Subwindows
#define OPTION_SUBW_X (SIDEBAR_X + SIDEBAR_W + MAIN_ELEMENT_MARGIN)
#define OPTION_SUBW_Y SIDEBAR_Y
#define OPTION_SUBW_W (WINDOW_WIDTH - SIDEBAR_W - 3 - (MAIN_ELEMENT_MARGIN * 3)) // - 3 to account for rect borders
#define OPTION_SUBW_H SIDEBAR_H

// Menu items
#define OPTION_ITEM_X OPTION_SUBW_X + 8
#define OPTION_ITEM_Y (OPTION_SUBW_Y + 12 + MAIN_ELEMENT_MARGIN) // 12: subwindow title bar height
#define OPTION_ITEM_W (OPTION_SUBW_W - (MAIN_ELEMENT_MARGIN * 2))
#define OPTION_ITEM_H 8
#define OPTION_ITEM_MARGIN 3

#define OPTION_EF_H 10
#define OPTION_EF_MAXCHARS 255
#define OPTION_EF_MAXPAINTCHARS 32

#define OPTION_COMBO_H 10
...
#define OPTION_COMBO_MAXITEMS(pos) ((OPTION_SUBW_Y + OPTION_SUBW_H - OPTION_COMBO_H - 2) - (OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)))) / OPTION_COMBO_H
#define OPTION_COMBO_MAXITEMS_REVERSE(pos) (OPTION_SUBW_Y + OPTION_SUBW_H - MAIN_ELEMENT_MARGIN + OPTION_ITEM_MARGIN - ((OPTION_ITEM_MARGIN + OPTION_ITEM_H) * (pos + 1)) - OPTION_ITEM_Y) / OPTION_COMBO_H

#define OPTION_ITEM_POS(pos) OPTION_ITEM_X, OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)), OPTION_ITEM_W, OPTION_ITEM_H
#define OPTION_ITEM_POS_REVERSE(pos) OPTION_ITEM_X, OPTION_SUBW_Y + OPTION_SUBW_H - MAIN_ELEMENT_MARGIN + OPTION_ITEM_MARGIN - ((OPTION_ITEM_MARGIN + OPTION_ITEM_H) * (pos + 1)), OPTION_ITEM_W, OPTION_ITEM_H
#define OPTION_EF_POS(pos) OPTION_ITEM_X, OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)), OPTION_ITEM_W, OPTION_EF_H //, OPTION_ITEM_W - MAIN_ELEMENT_MARGIN
#define OPTION_COMBO_POS(pos) OPTION_ITEM_X, OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)), OPTION_ITEM_W, OPTION_COMBO_H, OPTION_ITEM_W - MAIN_ELEMENT_MARGIN, OPTION_COMBO_MAXITEMS(pos), 0
#define OPTION_COMBO_POS_REVERSE(pos) OPTION_ITEM_X, OPTION_SUBW_Y + OPTION_SUBW_H - MAIN_ELEMENT_MARGIN + OPTION_ITEM_MARGIN - ((OPTION_ITEM_MARGIN + OPTION_ITEM_H) * (pos + 1)), OPTION_ITEM_W, OPTION_COMBO_H, OPTION_ITEM_W - MAIN_ELEMENT_MARGIN, OPTION_COMBO_MAXITEMS_REVERSE(pos), 1
#define OPTION_BUTTON_POS(pos) OPTION_ITEM_X, OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)), OPTION_ITEM_W, OPTION_ITEM_H * 2
#define OPTION_CHECKBOX_RIGHT_POS(pos) OPTION_ITEM_X, OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)), OPTION_ITEM_W * 0.5, OPTION_ITEM_H
#define OPTION_CHECKBOX_LEFT_POS(pos) OPTION_ITEM_X + OPTION_ITEM_W * 0.5, OPTION_ITEM_Y + ((OPTION_ITEM_H + OPTION_ITEM_MARGIN) * (pos - 1)), OPTION_ITEM_W * 0.5, OPTION_ITEM_H
...
#define SLIDER_LABEL_X (OPTION_ITEM_W - MAIN_ELEMENT_MARGIN)
