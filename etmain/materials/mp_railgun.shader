...
textures/mp_railgun/cable
{
	...
	{
		stage specularmap
		map textures/props/cable_m01_s.tga
		rgbGen vertex
	}
}
...
textures/mp_railgun/lmterrain_0
{
	...
	{
		stage specularmap
		map textures/snow_sd/s_dirt_m03i_2_big_s.tga
		rgbgen identity
	}
	{
		stage diffusemap
...
textures/mp_railgun/lmterrain_0to1
{
	...
	{
		stage specularmap
		map textures/snow_sd/bigrock_rounded_faint_s.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbgen identity
		alphaGen vertex
	}
...
textures/mp_railgun/lmterrain_0to2
{
	...
	{
		stage specularmap
		map textures/snow_sd/snow_var01_big_s.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbgen identity
		alphaGen vertex
	}
...
textures/mp_railgun/lmterrain_0to3
{
	...
	{
		stage specularmap
		map textures/snow_sd/snow_muddy_s.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbgen identity
		alphaGen vertex
	}
...
textures/mp_railgun/lmterrain_0to4
{
	...
	{
		stage specularmap
		map textures/snow_sd/mxrock4b_snow_s.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbgen identity
		alphaGen vertex
	}
...
textures/mp_railgun/lmterrain_0to5
{
	...
	{
		stage specularmap
		map textures/snow_sd/snow_noisy_s.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbgen identity
		alphaGen vertex
	}
...
textures/mp_railgun/lmterrain_0to6
{
	...
	{
		stage specularmap
		map textures/snow_sd/s_grass_ml03b_big_s.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbgen identity
		alphaGen vertex
	}
