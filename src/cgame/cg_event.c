...
void CG_EntityEvent(centity_t *cent, vec3_t position)
{
	...
	case EV_FILL_CLIP:
		...
		if (BG_IsSkillAvailable(cgs.clientinfo[clientNum].skill, SK_LIGHT_WEAPONS, 2) && (GetWeaponTableData(es->weapon)->attributes & WEAPON_ATTRIBUT_FAST_RELOAD) && cg_weapons[es->weapon].reloadFastSound)
		{
