...
static void CG_HudEditor_BackGround(panel_button_t *button);
...
static panel_button_t hudEditorColorSelectionText =
{
	NULL,
	"Text",
	{ SCREEN_OFFSETX,         HUDEDITOR_COLORSSTYLE_Y + HUDEDITOR_TITLE_SPACER_Y - BUTTON_HEIGHT,            BUTTON_WIDTH, BUTTON_HEIGHT },
	{ 0,                      0,                                                                             0,            5, 0, 0, 0, 1 },
	&hudEditorTextFont,       // font
