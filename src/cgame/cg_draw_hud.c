...
void CG_setDefaultHudValues(hudStucture_t *hud)
{
	...
	hud->popupmessages      = CG_getComponent(4, 245, 422, 96, qtrue, 64 | POPUP_WEAPON_ICON | POPUP_FILTER_PICKUP | POPUP_FILTER_TEAMJOIN, 100.f, colorWhite, colorWhite, qfalse, HUD_Background, qfalse, HUD_Border, ITEM_TEXTSTYLE_SHADOWED, ITEM_ALIGN_LEFT, qfalse, 0.22f, CG_DrawPM);
	hud->popupmessages2     = CG_getComponent(4, 245, 422, 96, qfalse, 64 | POPUP_WEAPON_ICON | POPUP_FILTER_PICKUP | POPUP_FILTER_TEAMJOIN, 100.f, colorWhite, colorWhite, qfalse, HUD_Background, qfalse, HUD_Border, ITEM_TEXTSTYLE_SHADOWED, ITEM_ALIGN_LEFT, qfalse, 0.22f, CG_DrawPM);
	hud->popupmessages3     = CG_getComponent(4, 245, 422, 96, qfalse, 64 | POPUP_WEAPON_ICON | POPUP_FILTER_PICKUP | POPUP_FILTER_TEAMJOIN, 100.f, colorWhite, colorWhite, qfalse, HUD_Background, qfalse, HUD_Border, ITEM_TEXTSTYLE_SHADOWED, ITEM_ALIGN_LEFT, qfalse, 0.22f, CG_DrawPM);
