...
void CG_setDefaultHudValues(hudStucture_t *hud)
{
	...
	hud->demotext         = CG_getComponent(CG_AdjustXFromHudFile(10, 57), 0, 57, 10, qtrue, 0, 100.f, colorRed, qfalse, HUD_Background, qfalse, HUD_Border, ITEM_TEXTSTYLE_SHADOWED, ITEM_ALIGN_LEFT, qfalse, 0.22f, CG_DrawDemoMessage);
