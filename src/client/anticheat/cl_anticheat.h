...
/**
 * @file cl_anticheat.h
 * @brief Client-side anti-cheat detection
 */

#ifndef INCLUDE_CL_ANTICHEAT_H
#define INCLUDE_CL_ANTICHEAT_H
...
// VM integrity data
typedef struct {
    vm_t *originalVM;               // Original VM pointer
    intptr_t (*originalSystemCall)(intptr_t *parms);  // Original systemCall function
    void *originalEntryPoint;       // Original entryPoint function
...
extern clAcIntegrity_t clAcIntegrity;

#endif // INCLUDE_CL_ANTICHEAT_H
