...
UNIFORM_DEF(UNIFORM_REFLECTIONMAP, u_ReflectionMap, GLSL_INT)
...
UNIFORM_DEF(UNIFORM_REFLECTIONTEXTUREMATRIX, u_ReflectionTextureMatrix, GLSL_MAT16)
...
UNIFORM_DEF(UNIFORM_BUMPSCALE, u_BumpScale, GLSL_FLOAT)
UNIFORM_DEF(UNIFORM_SHADOWCOMPARE, u_ShadowCompare, GLSL_FLOAT)
UNIFORM_DEF(UNIFORM_ETARATIO, u_EtaRatio, GLSL_VEC3)
UNIFORM_DEF(UNIFORM_SPECULARSCALE, u_SpecularScale, GLSL_FLOAT)
UNIFORM_DEF(UNIFORM_SPECULAREXPONENT, u_SpecularExponent, GLSL_FLOAT)
UNIFORM_DEF(UNIFORM_REFLECTIONSCALE, u_ReflectionScale, GLSL_FLOAT)
UNIFORM_DEF(UNIFORM_DIFFUSELIGHTING, u_DiffuseLighting, GLSL_FLOAT)
UNIFORM_DEF(UNIFORM_PARALLAXSHADOW, u_ParallaxShadow, GLSL_FLOAT)
...
TEX_DEF(TEX_REFLECTION, UNIFORM_REFLECTIONMAP)
