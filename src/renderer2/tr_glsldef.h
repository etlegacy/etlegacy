...
UNIFORM_DEF(UNIFORM_ATTEXY, u_AttenuationMapXY, GLSL_INT)
UNIFORM_DEF(UNIFORM_ATTEZ, u_AttenuationMapZ, GLSL_INT)
...
//UNIFORM_DEF(UNIFORM_SHADOWMVP, u_ShadowMvp, GLSL_MAT16)
//UNIFORM_DEF(UNIFORM_SHADOWMVP2, u_ShadowMvp2, GLSL_MAT16)
//UNIFORM_DEF(UNIFORM_SHADOWMVP3, u_ShadowMvp3, GLSL_MAT16)
...
UNIFORM_DEF(UNIFORM_DIFFUSETEXMATRIX, u_DiffuseTexMatrix, GLSL_VEC4)
UNIFORM_DEF(UNIFORM_DIFFUSETEXOFFTURB, u_DiffuseTexOffTurb, GLSL_VEC4)
UNIFORM_DEF(UNIFORM_TEXTURE1ENV, u_Texture1Env, GLSL_INT)

UNIFORM_DEF(UNIFORM_TCGEN0, u_TCGen0, GLSL_INT)
...
UNIFORM_DEF(UNIFORM_BASECOLOR, u_BaseColor, GLSL_VEC4)
UNIFORM_DEF(UNIFORM_VERTCOLOR, u_VertColor, GLSL_VEC4)
...
TEX_DEF(TEX_COLOR, UNIFORM_COLOR)
...
TEX_DEF(TEX_ATTEXY, UNIFORM_ATTEXY)
TEX_DEF(TEX_ATTEZ, UNIFORM_ATTEZ)
