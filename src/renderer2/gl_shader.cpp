...
const char* GLShader::GetFallbackShader(const char *name) const
{
	//This is an ugly way to plug this functionality in
	if(!Q_stricmp(name,"bloom_fp"))
	{
		return fallbackShader_bloom_fp;
	}
	else if(!Q_stricmp(name,"bloom_vp"))
	{
		return fallbackShader_bloom_vp;
	}
	else if(!Q_stricmp(name,"blurx_fp"))
	{
		return fallbackShader_blurx_fp;
	}
	else if(!Q_stricmp(name,"blurx_vp"))
	{
		return fallbackShader_blurx_vp;
	}
	else if(!Q_stricmp(name,"blury_fp"))
	{
		return fallbackShader_blury_fp;
	}
	else if(!Q_stricmp(name,"blury_vp"))
	{
		return fallbackShader_blury_vp;
	}
	...
	else if(!Q_stricmp(name,"contrast_vp"))
	{
		return fallbackShader_contrast_vp;
	}
	...
	else if(!Q_stricmp(name,"deferredlighting_fp"))
	{
		return fallbackShader_deferredlighting_fp;
	}
	else if(!Q_stricmp(name,"deferredlighting_vp"))
	{
		return fallbackShader_deferredlighting_vp;
	}
	else if(!Q_stricmp(name,"deferredshadowing_proj_fp"))
	{
		return fallbackShader_deferredshadowing_proj_fp;
	}
	else if(!Q_stricmp(name,"deferredshadowing_proj_vp"))
	{
		return fallbackShader_deferredshadowing_proj_vp;
	}
	else if(!Q_stricmp(name,"deformvertexes_vp"))
	{
		return fallbackShader_deformvertexes_vp;
	}
	...
	else if(!Q_stricmp(name,"depthoffield_vp"))
	{
		return fallbackShader_depthoffield_vp;
	}
	...
	else if(!Q_stricmp(name,"geometricfill_fp"))
	{
		return fallbackShader_geometricfill_fp;
	}
	else if(!Q_stricmp(name,"geometricfill_vp"))
	{
		return fallbackShader_geometricfill_vp;
	}
	...
	else if(!Q_stricmp(name,"reliefmapping_fp"))
	{
		return fallbackShader_reliefmapping_fp;
	}
	else if(!Q_stricmp(name,"rotoscope_fp"))
	{
		return fallbackShader_rotoscope_fp;
	}
	else if(!Q_stricmp(name,"rotoscope_vp"))
	{
		return fallbackShader_rotoscope_vp;
	}
	else if(!Q_stricmp(name,"screenspaceambientocclusion_fp"))
	{
		return fallbackShader_screenspaceambientocclusion_fp;
	}
	else if(!Q_stricmp(name,"screenspaceambientocclusion_vp"))
	{
		return fallbackShader_screenspaceambientocclusion_vp;
	}
	...
	else if(!Q_stricmp(name,"tonemapping_vp"))
	{
		return fallbackShader_tonemapping_vp;
	}
	else if(!Q_stricmp(name,"vertexanimation_vp"))
	{
		return fallbackShader_vertexanimation_vp;
	}
	...
	else if(!Q_stricmp(name,"vertexskinning_vp"))
	{
		return fallbackShader_vertexskinning_vp;
	}
