...
static const gentity_field_t gclient_fields[] =
{
	...
	_et_gclient_addfield(sess.team_health_given,            FIELD_INT,                 0),
	_et_gclient_addfield(sess.team_health_received,         FIELD_INT,                 0),
	_et_gclient_addfield(sess.enemy_health_given,           FIELD_INT,                 0),
	_et_gclient_addfield(sess.enemy_health_received,        FIELD_INT,                 0),
	_et_gclient_addfield(sess.team_revive_given,            FIELD_INT,                 0),
	_et_gclient_addfield(sess.team_revive_received,         FIELD_INT,                 0),
