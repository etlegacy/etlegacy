...
weaponTable_t weaponTable[WP_NUM_WEAPONS] =
{
	...
	{ WP_SMOKE_BOMB,           TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_SMOKE_BOMB,        WP_SMOKE_BOMB,        ET_MISSILE,            EF_BOUNCE_HALF | EF_BOUNCE, SVF_BROADCAST, TR_GRAVITY,     -50,   MASK_MISSILESHOT, qfalse,  qfalse, 0,     qfalse, qfalse,  0,     0,          0,           0,           qfalse,    qtrue,       qtrue,      qfalse,       qfalse,     qtrue,           qtrue,      qfalse,   qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "",                    WS_MAX,             qfalse, qfalse,  1,      0,   10,     0,        1,        1000,      DELAY_THROW,   1600,        0,                0,      0,       250,            250,             0,        { 16, -4, 24 },  2500,     0,       1.0f,      0,          0,        "smoke_bomb",      "smokegrenade",          WEAPON_CARD_NONE, { 1.f, 1.f, 0.f, 1.f, 0.f, 1.f },           WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHTO,   WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    MOD_SMOKEBOMB,            MOD_SMOKEBOMB            },  // WP_SMOKE_BOMB            // 29
