 ...
 * [0]  = weapon           -
 * [1]  = weapAlts         -
 * [2]  = weapEquiv        - the id of the opposite team's weapon (but not for WP_GPG40 <-> WP_M7 - see CG_OutOfAmmoChange).
 * [3]  = akimboSideArm    -
 * [4]  = ammoIndex        -
 * [5]  = clipIndex        -
 * [6]  = isScoped         -
 * [7]  = isLWSF           - Light Weapon Supporting Fast Reload
 * [8]  = damage           - returns 1 for no damage ... FIXME: some weapons are handled differently f.e. VERYBIGEXPLOSION
 * [9]  = canGib           -
 * [10] = isReload         - some weapons don't reload
 * [11] = spread           -
 * [12] = splashDamage     -
 * [13] = splashRadius     -
 * [14] = keepDisguise     -
 ...
 * [34] = desc             -
 * [35] = indexWeaponStat  -
 * [36] = maxAmmo          -   max player ammo carrying capacity.
 * [37] = uses             -   how many 'rounds' it takes/costs to fire one cycle.
 * [38] = maxClip          -   max 'rounds' in a clip.
 * [39] = startAmmo        -   player ammo when spawning.
 * [40] = startClip        -   player clips when spawning.
 * [41] = reloadTime       -   time from start of reload until ready to fire.
 * [42] = fireDelayTime    -   time from pressing 'fire' until first shot is fired. (used for delaying fire while weapon is 'readied' in animation)
 * [43] = nextShotTime     -   when firing continuously, this is the time between shots
 * [44] = maxHeat          -   max active firing time before weapon 'overheats' (at which point the weapon will fail for a moment)
 * [45] = coolRate         -   how fast the weapon cools down.
 * [46] = switchTimeBegin  -
 * [47] = switchTimeFinish -
 * [48] = className        -
 * [49] = mod              -   means of death.
 * [50] = splashMod        -   splash means of death.
 *
...
{
	// weapon                  team         weapAlts                weapEquiv          akimboSidearm   ammoIndex             clipIndex           isScoped isLWSF damage canGib isRealod spread spreadScale splashDamage splashRadius keepDisguise isAutoReaload isPistol isAkimbo isPanzer isRiflenade isRifle isMortar isMortarSet isMG    isMGSet isSetWeapon isLightWeapon isHeavyWeapon isSilencedPistol isMeleeWeapon isGrenade underWaterFire   noMuzzleFlash shakeEffect canHeat zoomOut zoomIn zoomedScope desc                   indexWeaponStat     useAmmo useClip  maxAmmo uses maxClip startAmmo startClip reloadTime firstDelayTime nextShotTime maxHeat coolRate switchTimeBegin switchTimeFinish knockback className         weapFile                 mod                       splashMod
	{ WP_NONE,                 TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_NONE,              WP_NONE,              qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qtrue,        qfalse,     qfalse, 0,      0,     0,          "WP_NONE",             WS_MAX,             qfalse, qfalse,  0,      0,   0,      0,        0,        0,         50,            0,           0,      0,       250,            250,             0,        "",               NULL,                    MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_NONE                  // 0
    { WP_KNIFE,                TEAM_ALLIES, WP_NONE,                WP_KNIFE_KABAR,          WP_NONE,  WP_KNIFE,             WP_KNIFE,             qfalse, qfalse, 10,  qtrue,  qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qtrue,        qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "KNIFE",               WS_KNIFE,           qfalse, qfalse,  999,    0,   999,    0,        0,        0,         50,            200,         0,      0,       250,            250,             0,        "",               "knife",                 MOD_KNIFE,                MOD_KNIFE                },  // WP_KNIFE                 // 1
	{ WP_LUGER,                TEAM_AXIS,   WP_SILENCER,            WP_COLT,                 WP_NONE,  WP_LUGER,             WP_LUGER,             qfalse, qtrue,  18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qfalse,      qtrue,        qtrue,   qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "LUGER",               WS_LUGER,           qtrue,  qtrue,   24,     1,   8,      24,       8,        1500,      DELAY_PISTOL,  400,         0,      0,       0,              0,               0,        "",               "luger",                 MOD_LUGER,                MOD_LUGER                },  // WP_LUGER                 // 2    // NOTE: also 32 round 'snail' magazine
	{ WP_MP40,                 TEAM_AXIS,   WP_NONE,                WP_THOMPSON,             WP_NONE,  WP_MP40,              WP_MP40,              qfalse, qtrue,  18,  qfalse, qtrue,  400,   0.6f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "MP 40",               WS_MP40,            qtrue,  qtrue,   90,     1,   30,     30,       30,       2400,      DELAY_LOW,     150,         0,      0,       250,            250,             0,        "",               "mp40",                  MOD_MP40,                 MOD_MP40                 },  // WP_MP40                  // 3
	{ WP_GRENADE_LAUNCHER,     TEAM_AXIS,   WP_NONE,                WP_GRENADE_PINEAPPLE,    WP_NONE,  WP_GRENADE_LAUNCHER,  WP_GRENADE_LAUNCHER,  qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          250,         250,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qtrue,    qtrue,           qtrue,        qtrue,      qfalse, 0,      0,     0,          "",                    WS_GRENADE,         qtrue,  qfalse,  45,     1,   15,     0,        4,        1000,      DELAY_THROW,   1600,        0,      0,       250,            250,             0,        "grenade",        "grenade",               MOD_GRENADE_LAUNCHER,     MOD_GRENADE_LAUNCHER     },  // WP_GRENADE_LAUNCHER      // 4
	{ WP_PANZERFAUST,          TEAM_AXIS,   WP_NONE,                WP_BAZOOKA,              WP_NONE,  WP_PANZERFAUST,       WP_PANZERFAUST,       qfalse, qfalse, 400, qtrue,  qfalse, 0,     0,          400,         300,         qfalse,      qfalse,       qfalse,  qfalse,  qtrue,   qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qtrue,      qfalse, 0,      0,     0,          "PANZERFAUST",         WS_PANZERFAUST,     qtrue,  qfalse,  4,      1,   1,      0,        4,        1000,      DELAY_HW,      2000,        0,      0,       250,            250,             32000.f,  "rocket",         "panzerfaust",           MOD_PANZERFAUST,          MOD_PANZERFAUST          },  // WP_PANZERFAUST           // 5    // updated delay so prediction is correct
	{ WP_FLAMETHROWER,         TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_FLAMETHROWER,      WP_FLAMETHROWER,      qfalse, qfalse, 5,   qfalse, qfalse, 0,     0,          5,           5,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "FLAMETHROWER",        WS_FLAMETHROWER,    qtrue,  qfalse,  200,    1,   200,    0,        200,      1000,      DELAY_LOW,     50,          0,      0,       250,            250,             2000.f,   "flamechunk",     "flamethrower",          MOD_FLAMETHROWER,         MOD_FLAMETHROWER         },  // WP_FLAMETHROWER          // 6
	{ WP_COLT,                 TEAM_ALLIES, WP_SILENCED_COLT,       WP_LUGER,                WP_NONE,  WP_COLT,              WP_COLT,              qfalse, qtrue,  18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qfalse,      qtrue,        qtrue,   qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "COLT",                WS_COLT,            qtrue,  qtrue,   24,     1,   8,      24,       8,        1500,      DELAY_PISTOL,  400,         0,      0,       0,              0,               0,        "",               "colt",                  MOD_COLT,                 MOD_COLT                 },  // WP_COLT                  // 7    // equivalent american weapon to german luger
	{ WP_THOMPSON,             TEAM_ALLIES, WP_NONE,                WP_MP40,                 WP_NONE,  WP_THOMPSON,          WP_THOMPSON,          qfalse, qtrue,  18,  qfalse, qtrue,  400,   0.6f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "THOMPSON",            WS_THOMPSON,        qtrue,  qtrue,   90,     1,   30,     30,       30,       2400,      DELAY_LOW,     150,         0,      0,       250,            250,             0,        "",               "thompson",              MOD_THOMPSON,             MOD_THOMPSON             },  // WP_THOMPSON              // 8    // equivalent american weapon to german mp40
	{ WP_GRENADE_PINEAPPLE,    TEAM_ALLIES, WP_NONE,                WP_GRENADE_LAUNCHER,     WP_NONE,  WP_GRENADE_PINEAPPLE, WP_GRENADE_PINEAPPLE, qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          250,         250,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qtrue,    qtrue,           qtrue,        qtrue,      qfalse, 0,      0,     0,          "",                    WS_GRENADE,         qtrue,  qfalse,  45,     1,   15,     0,        4,        1000,      DELAY_THROW,   1600,        0,      0,       250,            250,             0,        "grenade",        "pineapple",             MOD_GRENADE_PINEAPPLE,    MOD_GRENADE_PINEAPPLE    },  // WP_GRENADE_PINEAPPLE     // 9

	{ WP_STEN,                 TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_STEN,              WP_STEN,              qfalse, qtrue,  14,  qfalse, qtrue,  200,   0.6f,       0,           0,           qtrue,       qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qtrue,  0,      0,     0,          "STEN",                WS_STEN,            qtrue,  qtrue,   96,     1,   32,     32,       32,       3100,      DELAY_LOW,     150,         1200,   450,     250,            250,             0,        "",               "sten",                  MOD_STEN,                 MOD_STEN                 },  // WP_STEN                  // 10   // silenced sten sub-machinegun
	{ WP_MEDIC_SYRINGE,        TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_MEDIC_SYRINGE,     WP_MEDIC_SYRINGE,     qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "MEDIC",               WS_MAX,             qfalse, qfalse,  10,     1,   1,      0,        10,       1500,      50,            1000,        0,      0,       250,            250,             0,        "",               "syringe",               MOD_SYRINGE,              MOD_SYRINGE              },  // WP_MEDIC_SYRINGE         // 11   // broken out from CLASS_SPECIAL per Id request
	{ WP_AMMO,                 TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_AMMO,              WP_AMMO,              qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "AMMO",                WS_MAX,             qfalse, qfalse,  1,      0,   1,      0,        0,        3000,      50,            1000,        0,      0,       250,            250,             0,        "",               "ammopack",              MOD_AMMO,                 MOD_AMMO                 },  // WP_AMMO                  // 12   // likewise
	{ WP_ARTY,                 TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_ARTY,              WP_ARTY,              qfalse, qfalse, 1,   qtrue,  qfalse, 0,     0,          90,          50,          qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qtrue,      qfalse, 0,      0,     0,          "ARTY",                WS_ARTILLERY,       qfalse, qfalse,  1,      0,   1,      0,        1,        3000,      50,            1000,        0,      0,       250,            250,             0,        "",               "arty",                  MOD_ARTY,                 MOD_ARTY                 },  // WP_ARTY                  // 13
	{ WP_SILENCER,             TEAM_AXIS,   WP_LUGER,               WP_SILENCED_COLT,        WP_NONE,  WP_LUGER,             WP_LUGER,             qfalse, qtrue,  18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qtrue,           qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "SILENCED LUGER",      WS_LUGER,           qtrue,  qtrue,   24,     1,   8,      24,       8,        1500,      DELAY_PISTOL,  400,         0,      0,       1000,           1190,            0,        "",               "silenced_luger",        MOD_SILENCER,             MOD_SILENCER             },  // WP_SILENCER              // 14   // used to be sp5
	{ WP_DYNAMITE,             TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_DYNAMITE,          WP_DYNAMITE,          qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          400,         400,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qtrue ,     qfalse, 0,      0,     0,          "DYNAMITE",            WS_DYNAMITE,        qfalse, qfalse,  1,      0,   10,     0,        0,        1000,      DELAY_THROW,   1600,        0,      0,       250,            250,             0,        "dynamite",       "dynamite",              MOD_DYNAMITE,             MOD_DYNAMITE             },  // WP_DYNAMITE              // 15
	{ WP_SMOKETRAIL,           TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_SMOKETRAIL,        WP_SMOKETRAIL,        qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "",                    WS_ARTILLERY,       qfalse, qfalse,  999,    0,   999,    0,        0,        0,         50,            0,           0,      0,       250,            250,             0,        "WP",             "smoketrail",            MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_SMOKETRAIL            // 16   // WP == White Phosphorous, so we can check for bounce noise in grenade bounce routine
	{ WP_MAPMORTAR,            TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_MAPMORTAR,         WP_MAPMORTAR,         qfalse, qfalse, 250, qtrue,  qfalse, 0,     0,          250,         120,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qtrue,      qfalse, 0,      0,     0,          "",                    WS_MORTAR,          qtrue,  qfalse,  999,    0,   999,    0,        0,        0,         50,            0,           0,      0,       250,            250,             0,        "mortar",         "mapmortar",             MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_MAPMORTAR             // 17
	{ VERYBIGEXPLOSION,        TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_NONE,              WP_NONE,              qfalse, qfalse, 1,   qtrue,  qfalse, 0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "",                    WS_MAX,             qfalse, qfalse,  999,    0,   999,    0,        0,        0,         50,            0,           0,      0,       250,            250,             0,        "",               NULL,                    MOD_UNKNOWN,              MOD_UNKNOWN              },  // VERYBIGEXPLOSION         // 18   // explosion effect for airplanes
	{ WP_MEDKIT,               TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_MEDKIT,            WP_MEDKIT,            qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "",                    WS_MAX,             qfalse, qfalse,  999,    0,   999,    1,        1,        0,         50,            0,           0,      0,       250,            250,             0,        "",               "medpack",               MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_MEDKIT                // 19

	{ WP_BINOCULARS,           TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_BINOCULARS,        WP_BINOCULARS,        qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qfalse,       qfalse,     qfalse, 20/*36*/, 4/*8*/,     0,   "",                    WS_MAX,             qfalse, qfalse,  999,    0,   999,    0,        0,        0,         50,            0,           0,      0,       250,            250,             0,        "",               "binocs",                MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_BINOCULARS            // 20   // per atvi request all use same vals to match menu {36 8}
	{ WP_PLIERS,               TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_PLIERS,            WP_PLIERS,            qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "PLIERS",              WS_MAX,             qfalse, qfalse,  999,    0,   999,    0,        0,        0,         50,            0,           0,      0,       250,            250,             0,        "",               "pliers",                MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_PLIERS                // 21
	{ WP_SMOKE_MARKER,         TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_SMOKE_MARKER,      WP_SMOKE_MARKER,      qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          400,         400,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qtrue,      qfalse, 0,      0,     0,          "",                    WS_AIRSTRIKE,       qfalse, qfalse,  999,    0,   999,    0,        1,        0,         50,            0,           0,      0,       250,            250,             0,        "grenade",        "smokemarker",           MOD_AIRSTRIKE,            MOD_AIRSTRIKE            },  // WP_SMOKE_MARKER          // 22   // changed name to cause less confusion // damage was 140
	{ WP_KAR98,                TEAM_AXIS,   WP_GPG40,               WP_CARBINE,              WP_NONE,  WP_KAR98,             WP_KAR98,             qfalse, qfalse, 34,  qfalse, qtrue,  250,   0.5f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qtrue,  qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "K43",                 WS_KAR98,           qtrue,  qtrue,   30,     1,   10,     20,       10,       1500,      DELAY_LOW,     400,         0,      0,       0,              1347,            0,        "",               "kar98",                 MOD_KAR98,                MOD_KAR98                },  // WP_KAR98                 // 23   // WolfXP weapons    K43
	{ WP_CARBINE,              TEAM_ALLIES, WP_M7,                  WP_KAR98,                WP_NONE,  WP_CARBINE,           WP_CARBINE,           qfalse, qfalse, 34,  qfalse, qtrue,  250,   0.5f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qtrue,  qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "M1 GARAND",           WS_CARBINE,         qtrue,  qtrue,   30,     1,   10,     20,       10,       1500,      DELAY_LOW,     400,         0,      0,       0,              1347,            0,        "",               "m1_garand",             MOD_CARBINE,              MOD_CARBINE              },  // WP_CARBINE               // 24   // GARAND old max ammo 24 max clip size 8 start ammo 16 start clip 8
	{ WP_GARAND,               TEAM_ALLIES, WP_GARAND_SCOPE,        WP_K43,                  WP_NONE,  WP_GARAND,            WP_GARAND,            qfalse, qfalse, 34,  qfalse, qtrue,  250,   0.5f,       0,           0,           qtrue,       qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "SCOPED M1 GARAND",    WS_GARAND,          qtrue,  qtrue,   30,     1,   10,     20,       10,       1500,      DELAY_LOW,     400,         0,      0,       250,            250,             0,        "",               "m1_garand_s",           MOD_GARAND,               MOD_GARAND               },  // WP_GARAND                // 25   // GARAND old max ammo 24 max clip size 8 start ammo 16 start clip 8
	{ WP_LANDMINE,             TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_LANDMINE,          WP_LANDMINE,          qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          250,         225,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qtrue,      qfalse, 0,      0,     0,          "",                    WS_LANDMINE,        qtrue,  qfalse,  1,      0,   1,      0,        1,        100,       DELAY_LOW,     100,         0,      0,       250,            250,             0,        "landmine",       "landmine",              MOD_LANDMINE,             MOD_LANDMINE             },  // WP_LANDMINE              // 26   // splashRadius was: 400
	{ WP_SATCHEL,              TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_SATCHEL,           WP_SATCHEL,           qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          250,         250,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qtrue,        qfalse,     qfalse, 0,      0,     0,          "SATCHEL",             WS_MAX,             qfalse, qfalse,  1,      0,   1,      0,        0,        3000,      DELAY_LOW,     2000,        0,      0,       250,            250,             0,        "satchel_charge", "satchel",               MOD_SATCHEL,              MOD_SATCHEL              },  // WP_SATCHEL               // 27
	{ WP_SATCHEL_DET,          TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_SATCHEL_DET,       WP_SATCHEL_DET,       qfalse, qfalse, 1,   qtrue,  qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qtrue,        qtrue,      qfalse, 0,      0,     0,          "SATCHEL",             WS_SATCHEL,         qfalse, qfalse,  1,      0,   1,      0,        0,        3000,      722,           2000,        0,      0,       250,            250,             0,        "",               "satchel_det",           MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_SATCHEL_DET           // 28
	{ WP_SMOKE_BOMB,           TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_SMOKE_BOMB,        WP_SMOKE_BOMB,        qfalse, qfalse, 0,   qfalse, qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "",                    WS_MAX,             qfalse, qfalse,  1,      0,   10,     0,        1,        1000,      DELAY_THROW,   1600,        0,      0,       250,            250,             0,        "smoke_bomb",     "smokegrenade",          MOD_SMOKEBOMB,            MOD_SMOKEBOMB            },  // WP_SMOKE_BOMB            // 29

	{ WP_MOBILE_MG42,          TEAM_AXIS,   WP_MOBILE_MG42_SET,     WP_MOBILE_BROWNING,      WP_NONE,  WP_MOBILE_MG42,       WP_MOBILE_MG42,       qfalse, qfalse, 18,  qfalse, qtrue,  2500,  0.9f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qtrue,  qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qtrue,  0,      0,     0,          "MOBILE MG 42",        WS_MG42,            qtrue,  qtrue,   450,    1,   150,    0,        150,      3000,      DELAY_LOW,     66,          1500,   300,     0,              1722,            4000.f,   "",               "mg42",                  MOD_MOBILE_MG42,          MOD_MOBILE_MG42          },  // WP_MOBILE_MG42           // 30
    { WP_K43,                  TEAM_AXIS,   WP_K43_SCOPE,           WP_GARAND,               WP_NONE,  WP_K43,               WP_K43,               qfalse, qfalse, 34,  qfalse, qtrue,  250,   0.5f,       0,           0,           qtrue,       qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "SCOPED K43",          WS_K43,             qtrue,  qtrue,   30,     1,   10,     20,       10,       1500,      DELAY_LOW,     400,         0,      0,       250,            250,             0,        "",               "k43",                   MOD_K43,                  MOD_K43                  },  // WP_K43                   // 31    // K43
	{ WP_FG42,                 TEAM_FREE,   WP_FG42SCOPE,           WP_NONE,                 WP_NONE,  WP_FG42,              WP_FG42,              qfalse, qtrue,  16,  qfalse, qtrue,  500,   0.6f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "FG 42",               WS_FG42,            qtrue,  qtrue,   60,     1,   20,     40,       20,       2000,      DELAY_LOW,     100,         0,      0,       50,             50,              0,        "",               "fg42",                  MOD_FG42,                 MOD_FG42                 },  // WP_FG42                  // 32
	{ WP_DUMMY_MG42,           TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_DUMMY_MG42,        WP_DUMMY_MG42,        qfalse, qfalse, 1,   qfalse, qfalse, 0,     0.9f,       0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qtrue,  qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "",                    WS_MG42,            qfalse, qfalse,  0,      0,   0,      0,        0,        0,         0,             0,           1500,   300,     250,            250,             0,        "",               NULL,                    MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_DUMMY_MG42            // 33    // for storing heat on mounted mg42s...
	{ WP_MORTAR,               TEAM_AXIS,   WP_MORTAR_SET,          WP_MORTAR2,              WP_NONE,  WP_MORTAR,            WP_MORTAR,            qfalse, qfalse, 1,   qtrue,  qtrue,  0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qtrue,   qfalse,     qfalse, qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "MORTAR",              WS_MORTAR,          qtrue,  qfalse,  15,     1,   1,      0,        0,        0,         DELAY_HW,      1600,        0,      0,       250,            1000,            0,        "",               "mortar",                MOD_MORTAR,               MOD_MORTAR               },  // WP_MORTAR                // 34
	{ WP_AKIMBO_COLT,          TEAM_ALLIES, WP_NONE,                WP_AKIMBO_LUGER,         WP_COLT,  WP_COLT,              WP_AKIMBO_COLT,       qfalse, qfalse, 18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qfalse,      qtrue,        qfalse,  qtrue,   qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "AKIMBO COLTS",        WS_COLT,            qtrue,  qtrue,   48,     1,   8,      48,       8,        2700,      DELAY_PISTOL,  200,         0,      0,       250,            250,             0,        "",               "akimbo_colt",           MOD_AKIMBO_COLT ,         MOD_AKIMBO_COLT          },  // WP_AKIMBO_COLT           // 35
	{ WP_AKIMBO_LUGER,         TEAM_AXIS,   WP_NONE,                WP_AKIMBO_COLT,          WP_LUGER, WP_LUGER,             WP_AKIMBO_LUGER,      qfalse, qfalse, 18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qfalse,      qtrue,        qfalse,  qtrue,   qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "AKIMBO LUGERS",       WS_LUGER,           qtrue,  qtrue,   48,     1,   8,      48,       8,        2700,      DELAY_PISTOL,  200,         0,      0,       250,            250,             0,        "",               "akimbo_luger",          MOD_AKIMBO_LUGER,         MOD_AKIMBO_LUGER         },  // WP_AKIMBO_LUGER          // 36

	{ WP_GPG40,                TEAM_AXIS,   WP_KAR98,               WP_NONE,                 WP_NONE,  WP_GPG40,             WP_GPG40,             qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          250,         250,         qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qtrue,      qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qtrue,        qfalse,     qfalse, 0,      0,     0,          "",                    WS_GRENADELAUNCHER, qtrue,  qtrue,   4,      1,   1,      4,        1,        3000,      DELAY_LOW,     400,         0,      0,       0,              2350,            0,        "gpg40_grenade",  "gpg40",                 MOD_GPG40,                MOD_GPG40                },  // WP_GPG40                 // 37
    { WP_M7,                   TEAM_ALLIES, WP_CARBINE,             WP_NONE,                 WP_NONE,  WP_M7,                WP_M7,                qfalse, qfalse, 0,   qtrue,  qfalse, 0,     0,          250,         250,         qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qtrue,      qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qtrue,        qfalse,     qfalse, 0,      0,     0,          "",                    WS_GRENADELAUNCHER, qtrue,  qtrue,   4,      1,   1,      4,        1,        3000,      DELAY_LOW,     400,         0,      0,       0,              2350,            0,        "m7_grenade",     "m7",                    MOD_M7,                   MOD_M7                   },  // WP_M7                    // 38
	{ WP_SILENCED_COLT,        TEAM_ALLIES, WP_COLT,                WP_SILENCER,             WP_NONE,  WP_COLT,              WP_COLT,              qfalse, qfalse, 18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qtrue,       qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qtrue,           qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "SILENCED COLT",       WS_COLT,            qtrue,  qtrue,   24,     1,   8,      24,       8,        1500,      DELAY_PISTOL,  400,         0,      0,       1000,           1190,            0,        "",               "silenced_colt",         MOD_SILENCED_COLT,        MOD_SILENCED_COLT        },  // WP_SILENCED_COLT         // 39

	{ WP_GARAND_SCOPE,         TEAM_ALLIES, WP_GARAND,              WP_K43_SCOPE,            WP_NONE,  WP_GARAND,            WP_GARAND,            qtrue,  qfalse, 50,  qfalse, qtrue,  700,   10.f,       0,           0,           qtrue,       qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 20,     4,     900,        "",                    WS_GARAND,          qtrue,  qtrue,   30,     1,   10,     20,       10,       1500,      0,             400,         0,      0,       250,            250,             0,        "",               "m1_garand_s",           MOD_GARAND_SCOPE,         MOD_GARAND_SCOPE         },  // WP_GARAND_SCOPE          // 40    // GARAND  old max ammo 24 max clip size 8 start ammo 16 start clip 8
    { WP_K43_SCOPE,            TEAM_AXIS,   WP_K43,                 WP_GARAND_SCOPE,         WP_NONE,  WP_K43,               WP_K43,               qtrue,  qfalse, 50,  qfalse, qtrue,  700,   10.f,       0,           0,           qtrue,       qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 20,     4,     900,        "",                    WS_K43,             qtrue,  qtrue,   30,     1,   10,     20,       10,       1500,      0,             400,         0,      0,       250,            50,              0,        "",               "k43",                   MOD_K43_SCOPE,            MOD_K43_SCOPE            },  // WP_K43_SCOPE             // 41    // K43
	{ WP_FG42SCOPE,            TEAM_ALLIES, WP_FG42,                WP_NONE,                 WP_NONE,  WP_FG42,              WP_FG42,              qtrue,  qfalse, 30,  qfalse, qtrue,  200,   10.f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 55,     55,    1,          "FG 42",               WS_FG42,            qtrue,  qtrue,   60,     1,   20,     40,       20,       2000,      DELAY_LOW,     400,         0,      0,       50,             250,             0,        "",               "fg42",                  MOD_FG42SCOPE,            MOD_FG42SCOPE            },  // WP_FG42SCOPE             // 42
	{ WP_MORTAR_SET,           TEAM_AXIS,   WP_MORTAR,              WP_MORTAR2_SET,          WP_NONE,  WP_MORTAR,            WP_MORTAR,            qfalse, qfalse, 0,   qtrue,  qtrue,  0,     0,          400,         400,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qtrue,      qfalse, qfalse, qtrue,      qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "MORTAR",              WS_MORTAR,          qtrue,  qfalse,  16,     1,   1,      12,       0,        0,         DELAY_HW,      1400,        0,      0,       0,              1667,            0,        "mortar_grenade", "mortar_set",            MOD_MORTAR,               MOD_MORTAR               },  // WP_MORTAR_SET            // 43
	{ WP_MEDIC_ADRENALINE,     TEAM_FREE,   WP_NONE,                WP_NONE,                 WP_NONE,  WP_MEDIC_SYRINGE,     WP_MEDIC_SYRINGE,     qfalse, qfalse, 1,   qfalse, qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qfalse,       qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "ADRENALINE",          WS_MAX,             qfalse, qfalse,  10,     1,   1,      0,        10,       1500,      50,            1000,        0,      0,       250,            250,             0,        "",               "adrenaline",            MOD_SYRINGE,              MOD_SYRINGE              },  // WP_MEDIC_ADRENALINE      // 44
	{ WP_AKIMBO_SILENCEDCOLT,  TEAM_ALLIES, WP_NONE,                WP_AKIMBO_SILENCEDLUGER, WP_COLT,  WP_COLT,              WP_AKIMBO_COLT,       qfalse, qfalse, 18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qtrue,       qtrue,        qfalse,  qtrue,   qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "SLNCD AKIMBO COLTS",  WS_COLT,            qtrue,  qtrue,   48,     1,   8,      48,       8,        2700,      DELAY_PISTOL,  200,         0,      0,       250,            250,             0,        "",               "akimbo_silenced_colt",  MOD_AKIMBO_SILENCEDCOLT,  MOD_AKIMBO_SILENCEDCOLT  },  // WP_AKIMBO_SILENCEDCOLT   // 45
	{ WP_AKIMBO_SILENCEDLUGER, TEAM_AXIS,   WP_NONE,                WP_AKIMBO_SILENCEDCOLT,  WP_LUGER, WP_LUGER,             WP_AKIMBO_LUGER,      qfalse, qfalse, 18,  qfalse, qtrue,  600,   0.4f,       0,           0,           qtrue,       qtrue,        qfalse,  qtrue,   qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qtrue,        qfalse,       qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "SLNCD AKIMBO LUGERS", WS_LUGER,           qtrue,  qtrue,   48,     1,   8,      48,       8,        2700,      DELAY_PISTOL,  200,         0,      0,       250,            250,             0,        "",               "akimbo_silenced_luger", MOD_AKIMBO_SILENCEDLUGER, MOD_AKIMBO_SILENCEDLUGER },  // WP_AKIMBO_SILENCEDLUGER  // 46
	{ WP_MOBILE_MG42_SET,      TEAM_AXIS,   WP_MOBILE_MG42,         WP_MOBILE_BROWNING_SET,  WP_NONE,  WP_MOBILE_MG42,       WP_MOBILE_MG42,       qfalse, qfalse, 18,  qfalse, qtrue,  2500,  0.9f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qtrue,  qtrue,      qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qtrue,  55,     55,     0,         "MOBILE MG 42",        WS_MG42,            qtrue,  qtrue,   450,    1,   150,    0,        150,      3000,      DELAY_LOW,     66,          1500,   300,     0,              1250,            0,        "",               "mg42",                  MOD_MOBILE_MG42,          MOD_MOBILE_MG42          },  // WP_MOBILE_MG42_SET       // 47
	// legacy weapons
	{ WP_KNIFE_KABAR,          TEAM_ALLIES, WP_NONE,                WP_KNIFE,                WP_NONE,  WP_KNIFE_KABAR,       WP_KNIFE_KABAR,       qfalse, qfalse, 10,  qtrue,  qfalse, 0,     0,          0,           0,           qtrue,       qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qfalse,       qfalse,          qtrue,        qfalse,   qtrue,           qtrue,        qfalse,     qfalse, 0,      0,     0,          "KABAR",               WS_KNIFE_KBAR,      qfalse, qfalse,  999,    0,   999,    0,        0,        0,         50,            200,         0,      0,       250,            250,             0,        "",               "knife_kbar",            MOD_KNIFE_KABAR,          MOD_KNIFE_KABAR          },  // WP_KNIFE_KABAR           // 48
	{ WP_MOBILE_BROWNING,      TEAM_ALLIES, WP_MOBILE_BROWNING_SET, WP_MOBILE_MG42,          WP_NONE,  WP_MOBILE_BROWNING,   WP_MOBILE_BROWNING,   qfalse, qfalse, 18,  qfalse, qtrue,  2500,  0.9f,       0,           0,           qfalse,      qtrue,        qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qfalse,     qtrue,  qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qtrue,  0,      0,     0,          "MOBILE BROWNING",     WS_BROWNING,        qtrue,  qtrue,   450,    1,   150,    0,        150,      3000,      DELAY_LOW,     66,          1500,   300,     0,              1722,            4000.f,   "",               "browning",              MOD_MOBILE_BROWNING,      MOD_MOBILE_BROWNING      },  // WP_MOBILE_BROWNING       // 49
	...
	{ WP_MORTAR2,              TEAM_ALLIES, WP_MORTAR2_SET,         WP_MORTAR,               WP_NONE,  WP_MORTAR2,           WP_MORTAR2,           qfalse, qfalse, 1,   qtrue,  qtrue,  0,     0,          0,           0,           qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qtrue,   qfalse,     qfalse, qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "GRANATWERFER",        WS_MORTAR2,         qtrue,  qfalse,  15,     1,   1,      0,        0,        0,         DELAY_HW,      1600,        0,      0,       0,              1000,            0,        "",               "axis_mortar",           MOD_MORTAR2,              MOD_MORTAR2              },  // WP_MORTAR2			     // 51
	{ WP_MORTAR2_SET,          TEAM_ALLIES, WP_MORTAR2,             WP_MORTAR_SET,           WP_NONE,  WP_MORTAR2,           WP_MORTAR2,           qfalse, qfalse, 0,   qtrue,  qtrue,  0,     0,          400,         400,         qfalse,      qfalse,       qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qfalse,  qtrue,      qfalse, qfalse, qtrue,      qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "GRANATWERFER",        WS_MORTAR2,         qtrue,  qfalse,  16,     1,   1,      12,       0,        0,         DELAY_HW,      1400,        0,      0,       0,              1667,            0,        "mortar_grenade", "axis_mortar_set",       MOD_MORTAR2,              MOD_MORTAR2              },  // WP_MORTAR2_SET		     // 52
	{ WP_BAZOOKA,              TEAM_ALLIES, WP_NONE,                WP_PANZERFAUST,          WP_NONE,  WP_BAZOOKA,           WP_BAZOOKA,           qfalse, qfalse, 400, qtrue,  qfalse, 0,     0,          400,         300,         qfalse,      qfalse,       qfalse,  qfalse,  qtrue,   qfalse,     qfalse, qfalse,  qfalse,     qfalse, qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qtrue,      qfalse, 0,      0,     0,          "BAZOOKA",             WS_BAZOOKA,         qtrue,  qfalse,  4,      1,   1,      0,        4,        1000,      DELAY_HW,      2000,        0,      0,       250,            250,             32000.f,  "rocket",         "bazooka",               MOD_BAZOOKA,              MOD_BAZOOKA              },  // WP_BAZOOKA               // 53
};
