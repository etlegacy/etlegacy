...
weaponTable_t weaponTable[WP_NUM_WEAPONS] =
{
	...
	{ WP_MORTAR,               TEAM_ALLIES, WP_MORTAR_SET,          WP_MORTAR2,              WP_NONE,  WP_MORTAR,            WP_MORTAR,            ET_GENERAL,            EF_NONE,                    SVF_NONE,      TR_LINEAR,      0,     MASK_MISSILESHOT, qfalse,  qfalse, 1,     qtrue,  qtrue,   0,     0,          0,           0,           qfalse,    qfalse,      qfalse,     qfalse,       qtrue,      qfalse,          qfalse,     qfalse,   qfalse,  qfalse,  qfalse,  qfalse,     qfalse, qtrue,   qfalse,     qfalse, qfalse, qfalse,     qfalse,       qtrue,        qfalse,          qfalse,       qfalse,   qfalse,          qfalse,       qfalse,     qfalse, 0,      0,     0,          "MORTAR",              WS_MORTAR,          qtrue,  qfalse,  15,     1,   1,      0,        0,        0,         DELAY_HW,      1600,        0,                0,      0,       0,              1000,            0,        { 16, -4, 24 },  0,        0,       1.0f,      0,          0,        "",                "mortar",                WEAPON_CARD_1,    { 1.f, 1.f, 0.f, 1.f, 0 / 8.f, 1 / 8.f },   WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHFROM, WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    MOD_MORTAR,               MOD_MORTAR               },  // WP_MORTAR                // 34
