...
modTable_t modTable[MOD_NUM_MODS] =
{
	...
	{ MOD_FEAR,                               WP_NONE,                 qfalse,     qfalse,    WEAPON_CLASS_FOR_MOD_NO,       qfalse,       "was scared to death by",    "",                               "killed himself",                        NULL,                                     "MOD_FEAR",                               SK_NUM_SKILLS,                               3.f,             0.f,             {0.f, 0.f, 0.f, 0.f}, qfalse,      "",                    0,            WS_MAX             },
};
