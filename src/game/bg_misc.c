 ...
 * [23]  = useClip              - 
 * [24]  = useBullet            - 
 * [25]  = maxAmmo              - max player ammo carrying capacity.
 * [26]  = uses                 - how many 'rounds' it takes/costs to fire one cycle.
 * [27]  = maxClip              - max 'rounds' in a clip.
 * [28]  = reloadTime           - time from start of reload until ready to fire.
 * [29]  = fireDelayTime        - time from pressing 'fire' until first shot is fired. (used for delaying fire while weapon is 'readied' in animation)
 * [30]  = nextShotTime         - when firing continuously, this is the time between shots
 * [31]  = grenadeTime          - 
 * [32]  = aimSpreadScaleAdd    - 
 * [33]  = maxHeat              - max active firing time before weapon 'overheats' (at which point the weapon will fail for a moment)
 * [34]  = coolRate             - how fast the weapon cools down.
 * [35]  = heatRecoveryTime     - time from overheats until weapon can fire again
 * [36]  = switchTimeBegin      - 
 * [37]  = switchTimeFinish     - 
 * [38]  = altSwitchTimeBegin   - 
 * [39]  = altSwitchTimeFinish  - 
 * [40]  = knockback            - 
 * [41]  = adjustLean           - 
 * [42]  = fireRecoilPitch      - 
 * [43]  = fireRecoilYaw        - 
 * [44]  = weapRecoilDuration   - 
 * [45]  = weapRecoilPitch      - 
 * [46]  = weapRecoilYaw        - 
 * [47]  = className            - 
 * [48]  = weapFile             - 
...
weaponTable_t weaponTable[WP_NUM_WEAPONS] =
{
	...
	{ WP_AKIMBO_SILENCEDLUGER, ITEM_WEAPON_AKIMBO_SILENCED_LUGER, TEAM_AXIS,   SK_LIGHT_WEAPONS,                            WP_NONE,                WP_AKIMBO_SILENCEDCOLT,  WP_LUGER, WP_LUGER,             WP_AKIMBO_LUGER,      18,    600,   0.4f,       0,           0,           WEAPON_TYPE_PISTOL,                        WEAPON_FIRING_MODE_SEMI_AUTOMATIC,                           WEAPON_ATTRIBUT_AKIMBO | WEAPON_ATTRIBUT_SILENCED | WEAPON_ATTRIBUT_KEEP_DESGUISE | WEAPON_ATTRIBUT_FALL_OFF,                                                0,      0,     "SLNCD AKIMBO LUGERS", WS_LUGER,           qtrue,  qtrue,   qtrue,    48,     1,   8,      2700,      DELAY_PISTOL,  200,         0,          20,               0,      0,       0,               250,            250,             250,               250,                0,        { 14, -6, -4 },   1.0f,      0,              0,            100,               { .45f, .15f }, { 0, 0 },      "",                "akimbo_silenced_luger", WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHTO,   WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    {1, 1, 1, 1, 1},                     MOD_AKIMBO_SILENCEDLUGER, MOD_AKIMBO_SILENCEDLUGER },  // WP_AKIMBO_SILENCEDLUGER  // 46
