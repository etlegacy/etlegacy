...
weaponTable_t weaponTable[WP_NUM_WEAPONS] =
{
    ...
    { WP_NONE,                 ITEM_NONE,                         TEAM_FREE,   SK_NUM_SKILLS,                               WP_NONE,                WP_NONE,                 WP_NONE,  WP_NONE,              WP_NONE,              1,     0,     0,          0,           0,           WEAPON_TYPE_NONE,                          WEAPON_FIRING_MODE_NONE,                                     WEAPON_ATTRIBUT_KEEP_DESGUISE | WEAPON_ATTRIBUT_NEVER_LOST_DESGUISE,                                                                                         0,      0,     "WP_NONE",             WS_MAX,             qfalse, qfalse, 0,      0,   0,      0,         50,            0,           0,          0,                0,      0,       0,               250,            250,             250,               250,                0,        { 0, 0, 0 },      1.0f,      0,              0,            0,                 { 0, 0 },       { 0, 0 },      "",                NULL,                    WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHTO,   WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    {1, 1, 1, 1, 1},                     MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_NONE                  // 0
	...
	{ WP_FLAMETHROWER,         ITEM_WEAPON_FLAMETHROWER,          TEAM_FREE,   SK_HEAVY_WEAPONS,                            WP_NONE,                WP_NONE,                 WP_NONE,  WP_FLAMETHROWER,      WP_FLAMETHROWER,      5,     0,     0,          5,           5,           WEAPON_TYPE_NONE,                          WEAPON_FIRING_MODE_NONE,                                     WEAPON_ATTRIBUT_NONE,                                                                                                                                        0,      0,     "FLAMETHROWER",        WS_FLAMETHROWER,    qtrue,  qfalse, 200,    1,   200,    0,         DELAY_LOW,     50,          0,          0,                0,      0,       0,               250,            250,             250,               250,                2000.f,   { 14, 6, -4 },    2.0f,      0,              0,            0,                 { 0, 0 },       { 0, 0 },      "flamechunk",      "flamethrower",          WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHTO,   WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    {1, 1, 1, 1, 1},                     MOD_FLAMETHROWER,         MOD_FLAMETHROWER         },  // WP_FLAMETHROWER          // 6
	...
	{ WP_SMOKE_MARKER,         ITEM_WEAPON_SMOKE_MARKER,          TEAM_FREE,   SK_SIGNALS,                                  WP_NONE,                WP_NONE,                 WP_NONE,  WP_SMOKE_MARKER,      WP_SMOKE_MARKER,      0,     0,     0,          400,         400,         WEAPON_TYPE_NONE,                          WEAPON_FIRING_MODE_THROWABLE | WEAPON_FIRING_MODE_ONE_SHOT,  WEAPON_ATTRIBUT_CHARGE_TIME | WEAPON_ATTRIBUT_SHAKE,                                                                                                         0,      0,     "",                    WS_AIRSTRIKE,       qfalse, qfalse, 999,    0,   999,    0,         50,            1000,        0,          0,                0,      0,       0,               250,            250,             250,               250,                0,        { 14, 6, -4 },    1.0f,      0,              0,            0,                 { 0, 0 },       { 0, 0 },      "grenade",         "smokemarker",           WEAP_IDLE1, WEAP_ATTACK1, WEAP_ATTACK_LASTSHOT, WEAP_ALTSWITCHFROM, WEAP_ALTSWITCHTO,   WEAP_RELOAD1, WEAP_RAISE,   WEAP_DROP,    {1, 1, .66f, .66f, .66f},            MOD_AIRSTRIKE,            MOD_AIRSTRIKE            },  // WP_SMOKE_MARKER          // 22   // changed name to cause less confusion // damage was 140
...
void BG_EvaluateTrajectory(const trajectory_t *tr, int atTime, vec3_t result, qboolean isAngle, int splinePath)
{
	...
	case TR_SINE:
		...
		phase     = sin(deltaTime * M_2PI); // * M_PI * 2
	...
	case TR_SPLINE:
		...
		if (isAngle)
		{
			...
			if (dampin && dampout)
			{
				...
				result[ROLL] = base1 + ((sin(((deltaTime * 2.0f) - 1.0f) * M_halfPI) + 1.0f) * 0.5f * tr->trBase[2]);
			}
			else if (dampin)
			{
				//result[ROLL] = base1 + (sin(deltaTime * M_PI * 0.5) * tr->trBase[2]);
				result[ROLL] = base1 + (sin(deltaTime * M_halfPI) * tr->trBase[2]);
			}
			else if (dampout)
			{
				//result[ROLL] = base1 + ((1 - sin((1 - deltaTime) * M_PI * 0.5)) * tr->trBase[2]);
				result[ROLL] = base1 + ((1.0f - sin((1.0f - deltaTime) * M_halfPI)) * tr->trBase[2]);
			}
			else
			{
...
void BG_GetMarkDir(const vec3_t dir, const vec3_t normal, vec3_t out)
{
	...
	// make sure it marks the impact surface
