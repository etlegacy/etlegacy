...
weaponTable_t weaponTable[WP_NUM_WEAPONS] =
{
	...
	{ WP_DUMMY_MG42,           ITEM_WEAPON_DUMMY_MG42,            TEAM_FREE,   SK_NUM_SKILLS,                               WP_NONE,                WP_NONE,                 WP_NONE,  WP_DUMMY_MG42,        WP_DUMMY_MG42,        20,    100,   0.9f,       0,           0,           WEAPON_TYPE_NONE,                          WEAPON_FIRING_MODE_NONE,                                     WEAPON_ATTRIBUT_FALL_OFF,                                                                                                                                    0,      0,     "",                    WS_MG42,            qfalse, qfalse, 0,      0,   0,      0,         0,             50,          0,          0,                1500,   330,     2000,            250,            250,             0,                0,              0,        { 14, 6, -4 },    0,                 { 0, 0 },       { 0, 0 },      "",                NULL,                    0,                                {1, 1},         MOD_UNKNOWN,              MOD_UNKNOWN              },  // WP_DUMMY_MG42            // 33    // for storing heat on mounted mg42s...
