...
#define EBS_SC_VERSION_SIZE 4
#define EBS_SC_SLOTMASK_SIZE 6

#define EBS_SC_CLIENTNUM_SIZE 6
#define EBS_SC_HEALTH_SIZE 9
#define EBS_SC_AMMOCLIP_SIZE 10
#define EBS_SC_AMMO_SIZE 10
#define EBS_SC_PLAYER_SIZE (EBS_SC_CLIENTNUM_SIZE + EBS_SC_HEALTH_SIZE + EBS_SC_AMMOCLIP_SIZE + EBS_SC_AMMO_SIZE)

// ET_EBS_FIRETEAM fields sizes
#define EBS_FT_VERSION_SIZE 4
#define EBS_FT_SLOTMASK_SIZE 6

#define EBS_FT_CLIENTNUM_SIZE 6
#define EBS_FT_HEALTH_SIZE 9
#define EBS_FT_WEAPON_SIZE 6
#define EBS_FT_MAJORSPAWN_SIZE 4 // MAX_MULTI_SPAWNTARGETS >> 2
#define EBS_FT_MINORSPAWN_SIZE 8
#define EBS_FT_PLAYER_SIZE (EBS_FT_CLIENTNUM_SIZE + EBS_FT_HEALTH_SIZE + EBS_FT_WEAPON_SIZE + EBS_FT_MAJORSPAWN_SIZE + EBS_FT_MINORSPAWN_SIZE)
