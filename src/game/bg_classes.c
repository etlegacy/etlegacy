	...
	{
		{
			...
			WP_KNIFE,
			{
				{ WP_MP40,                 SK_LIGHT_WEAPONS,                            0 },
				{ WP_MOBILE_MG42,          SK_HEAVY_WEAPONS,                            0 },
				{ WP_FLAMETHROWER,         SK_HEAVY_WEAPONS,                            0 },
				{ WP_PANZERFAUST,          SK_HEAVY_WEAPONS,                            0 },
				{ WP_MORTAR2,              SK_HEAVY_WEAPONS,                            0 },
			},
			{
				{ WP_LUGER,                SK_LIGHT_WEAPONS,                            0 },
				{ WP_AKIMBO_LUGER,         SK_LIGHT_WEAPONS,                            4 },
				{ WP_MP40,                 SK_HEAVY_WEAPONS,                            4 },
			},
	...
	{
		{
			...
			WP_KNIFE_KABAR,
			{
				{ WP_THOMPSON,             SK_LIGHT_WEAPONS,                            0 },
				{ WP_MOBILE_BROWNING,      SK_HEAVY_WEAPONS,                            0 },
				{ WP_FLAMETHROWER,         SK_HEAVY_WEAPONS,                            0 },
				{ WP_BAZOOKA,              SK_HEAVY_WEAPONS,                            0 },
				{ WP_MORTAR,               SK_HEAVY_WEAPONS,                            0 },
			},
			{
				{ WP_COLT,                 SK_LIGHT_WEAPONS,                            0 },
				{ WP_AKIMBO_COLT,          SK_LIGHT_WEAPONS,                            4 },
				{ WP_THOMPSON,             SK_HEAVY_WEAPONS,                            4 },
			},
			WP_GRENADE_PINEAPPLE, 4,
			{
				{ WP_BINOCULARS,           SK_BATTLE_SENSE,                             1 },
			},
			0,
...

		{
			...
			{
				{ WP_SILENCED_COLT,        SK_LIGHT_WEAPONS,                            0 },
				{ WP_AKIMBO_SILENCEDCOLT,  SK_LIGHT_WEAPONS,                            4 },
			},
			WP_GRENADE_PINEAPPLE, 2,
			{
				{ WP_SMOKE_BOMB,           SK_MILITARY_INTELLIGENCE_AND_SCOPED_WEAPONS, 0 },
				{ WP_SATCHEL,              SK_MILITARY_INTELLIGENCE_AND_SCOPED_WEAPONS, 0 },
				{ WP_SATCHEL_DET,          SK_MILITARY_INTELLIGENCE_AND_SCOPED_WEAPONS, 0 },
