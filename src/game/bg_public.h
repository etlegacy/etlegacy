...
#define PRONE_BODYHEIGHT_BBOX 24    ///< back to vanilla behaviour, previous value was the magic number for the minimum maxs[2] that prevents player from getting stuck into the world.
